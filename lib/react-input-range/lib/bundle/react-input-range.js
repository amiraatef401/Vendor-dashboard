(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports.InputRange = factory(require('react'));
  else root.InputRange = factory(root.React);
}(this, __WEBPACK_EXTERNAL_MODULE_3__ => (function (modules) { // webpackBootstrap
  /** *** */ 	// The module cache
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _captialize = __webpack_require__(19);
    ...
    const _clamp = __webpack_require__(20);
    ...
    const _distanceTo = __webpack_require__(21);
    ...
    const _isDefined = __webpack_require__(22);
    ...
    const _isNumber = __webpack_require__(23);
    ...
    const _isObject = __webpack_require__(24);
    ...
    const _length = __webpack_require__(25);
 ...
 */
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _react = __webpack_require__(3);

    const _react2 = _interopRequireDefault(_react);

    const _propTypes = __webpack_require__(2);
 ...
 *
 */
      const emptyFunction = __webpack_require__(5);
 ...
 */
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _autobindDecorator = __webpack_require__(4);

    const _autobindDecorator2 = _interopRequireDefault(_autobindDecorator);

    const _valueTransformer = __webpack_require__(18);

    const valueTransformer = _interopRequireWildcard(_valueTransformer);

    const _defaultClassNames = __webpack_require__(12);

    const _defaultClassNames2 = _interopRequireDefault(_defaultClassNames);

    const _label = __webpack_require__(7);

    const _label2 = _interopRequireDefault(_label);

    const _rangePropType = __webpack_require__(14);

    const _rangePropType2 = _interopRequireDefault(_rangePropType);

    const _valuePropType = __webpack_require__(17);

    const _valuePropType2 = _interopRequireDefault(_valuePropType);

    const _slider = __webpack_require__(15);

    const _slider2 = _interopRequireDefault(_slider);

    const _track = __webpack_require__(16);

    const _track2 = _interopRequireDefault(_track);

    const _utils = __webpack_require__(1);

    const _keyCodes = __webpack_require__(13);
 ...
 */
    const InputRange = (_class = (function (_React$Component) {
     ...
     * @type {?number}
     */
        const _this = _possibleConstructorReturn(this, (InputRange.__proto__ || Object.getPrototypeOf(InputRange)).call(this, props));
   ...
   */
     ...
     */
        ...
        value: function getKeyByPosition(position) {
          ...
          if (this.isMultiValue()) {
            const distanceToMin = (0, _utils.distanceTo)(position, positions.min);
            const distanceToMax = (0, _utils.distanceTo)(position, positions.max);
     ...
     */
        ...
        value: function handleSliderDrag(event, key) {
          ...
          requestAnimationFrame(() => _this2.updatePosition(key, position));
        },
     ...
     */
        ...
        value: function handleTrackDrag(event, prevEvent) {
          ...
          const maxValue = _props.maxValue;


          const minValue = _props.minValue;


          const _props$value = _props.value;


          const max = _props$value.max;


          const min = _props$value.min;
     ...
     */
        ...
        value: function handleTrackMouseDown(event, position) {
          ...
          const maxValue = _props2.maxValue;


          const minValue = _props2.minValue;


          const _props2$value = _props2.value;


          const max = _props2$value.max;


          const min = _props2$value.min;
     ...
     */
        ...
        value: function renderSliders() {
          ...
          const keys = this.props.allowSameValues && this.lastKeyMoved === 'min' ? this.getKeys().reverse() : this.getKeys();

          return keys.map((key) => {
            const value = values[key];
            const percentage = percentages[key];

            const _props3 = _this3.props;


            let maxValue = _props3.maxValue;


            let minValue = _props3.minValue;
            ...
            const slider = _react2.default.createElement(_slider2.default, {
     ...
     */
        ...
        value: function renderHiddenInputs() {
          ...
          return this.getKeys().map((key) => {
            const value = values[key];
            const name = isMultiValue ? `${_this4.props.name}${(0, _utils.captialize)(key)}` : _this4.props.name;

            return _react2.default.createElement('input', {
              key, type: 'hidden', name, value,
            });
          });
        },
  ...
  /** */ (function (module, exports, __webpack_require__) {
    ...
    const _inputRange = __webpack_require__(10);

    const _inputRange2 = _interopRequireDefault(_inputRange);
 ...
 * @ignore
 */
    const Slider = (_class = (function (_React$Component) {
     ...
     * @type {?Component}
     */
        const _this = _possibleConstructorReturn(this, (Slider.__proto__ || Object.getPrototypeOf(Slider)).call(this, props));
 ...
 * @ignore
 */
    const Track = (_class = (function (_React$Component) {
     ...
     * @type {?Component}
     */
        const _this = _possibleConstructorReturn(this, (Track.__proto__ || Object.getPrototypeOf(Track)).call(this, props));
 ...
 */
    function getPercentageFromValue(value, minValue, maxValue) {
      const validValue = (0, _utils.clamp)(value, minValue, maxValue);
      const valueDiff = maxValue - minValue;
 ...
 */
    function getPositionFromEvent(event, clientRect) {
      ...
      const _ref = event.touches ? event.touches[0] : event;


      const clientX = _ref.clientX;
 ...
 */
      const emptyFunction = __webpack_require__(5);
      const invariant = __webpack_require__(6);
      const warning = __webpack_require__(8);

      const ReactPropTypesSecret = __webpack_require__(9);
      const checkPropTypes = __webpack_require__(26);
